...
layout =    [[sg.Image('recursos\imagens\Logo700x100.png')],
            ...
            [sg.Text('LEGENDA DA FOTO Não obrigatório:',text_color=background_fonte, background_color='#3CB371',font=('Arial', 10, 'bold'))],
            [sg.Multiline(size=(30,2),key='legenda')],
            [sg.Text('Saudação:', text_color=background_fonte, background_color='#3CB371',font=('Arial', 10, 'bold'))],
            [sg.Multiline(size=(30, 2), key='textbox'),],

            [sg.Text('Resposta:',text_color=background_fonte, background_color='#3CB371',font=('Arial', 10, 'bold'))],
            [sg.Multiline(size=(30, 2), key='response')],
            ...
            [sg.Button('Iniciar', button_color=(background_fonte,background_fundo), key='iniciar'), sg.Button('Responder', button_color=(background_fonte,background_fundo), key='responder'),sg.Text('                  ', background_color='#1C1C1C', key='status')]]


layout2 = [
    [sg.Image('recursos\imagens\convertido.png')],
    ...
    [sg.Text("5º Número",text_color=background_fonte, background_color='#3CB371',font=('Arial',12))],
    [sg.Input(key="n5",size=(13, 1))],
    [sg.Text("6º Número",text_color=background_fonte, background_color='#3CB371',font=('Arial',12))],
...
layout_principal = [
    ...
    [sg.Frame("Configurações de envio de mensagens",layout2, background_color='#3CB371',border_width='5px', title_color='#000000'),sg.Frame('Acões',layout, background_color='#3CB371', border_width='5px', title_color='#000000')],
    [sg.Frame("Tutorial",layout3, background_color='#3CB371', border_width='5px', title_color='#000000')]


]

window = sg.Window('BotWhatsapp', layout_principal).Finalize()
